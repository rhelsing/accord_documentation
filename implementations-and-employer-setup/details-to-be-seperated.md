...
1. Client Integration - Source of Client is Needed - Onboarding Process / Portal / Proposal
...
* Client Sets-Up Account Online \(Done before Kick-Off Call or with Account Manager on Call\)
  ...
  1. Information Needed
    ...
    1. Service Type \(Full Service, Forms Only, Forms Express\)
  ...
  * Implementation Call with Account Manager
    ...
    1. Key Steps for Call
      ...
      1. Full Accord Team Introductions
      ...
      * Go over Data needed depending on client type
        ...
        1. If they are Full Service - historical data is needed for payroll and medical \(depending on where the medical files are coming from - could be various vendors\)

          1. Payroll needs to be historical for 14 months, i.e. if they go live on June 1, 2017 then the files need to go back to April 1, 2016
        ...
        * If they are Forms only \(no tracking done\) - demographic files are needed as a base
          ...
          1. Demographic files to show all employees for the current year are needed back up agains medical files
    ...
    * Client Follow-Up
      ...
      1. Continued Follow-Up each week until test data is received by client

    * On-going client follow-up

      1. Full Service Clients

        1. Follow-up Monthly as data is coming in.

          1. If client is not sending data as required - Follow-up weekly until data is received

      1. Forms Only Clients

        1. Follow-up to touch base once a quarter, until end of the year data is needed.

          1. Touch base each week to continue data coming in.
